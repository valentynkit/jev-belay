...
__ for the wording alone, on 100 labeled stops out of a 2,367-stop corpus, at about
$0.00002 a decision.
...
| latency | under 2 s through a gateway shim; TypeSafe documents about 100 ms direct, and the hook budget is 20 s inside a 25 s timeout |
| stops that reach it | 18.2% (430 of 2,367 stops in one real corpus) |
